...
def generic_arg_parser() -> ap.ArgumentParser:
    ...
    required.add_argument(
        ...
        '-s',
        help='''
            name of the file to write the demux statistics to
        ''',
        required=True
    )
...
def main_arg_parser() -> ap.ArgumentParser:
    ...
    subparsers.add_parser(
        ...
        help = '''
            ...
            -m/--mismatches to change this. However, it is advised to set this argument to min(bc_hamming_dist) - 1
    ...
    subparsers.add_parser(
        ...
        help='''
            ...
            min(bc_hamming_dist) - 1 in order to avoid erroneous assignment of reads to samples, where bc_hamming_dist 
            is a set of pairwise hamming distances between all true barcodes. Reads that cannot be safely assigned 
